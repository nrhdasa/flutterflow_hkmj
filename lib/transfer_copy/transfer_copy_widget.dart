...
class TransferCopyWidget extends StatefulWidget {
  const TransferCopyWidget({Key key}) : super(key: key);

  @override
  _TransferCopyWidgetState createState() => _TransferCopyWidgetState();
}

class _TransferCopyWidgetState extends State<TransferCopyWidget> {
